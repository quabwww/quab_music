...
async def musica(req: Req):
    ...
    try:
        ...
        videosSearch = VideosSearch(req.url, limit = 1)
        return JSONResponse({"voice": True, "data": search_url, "message": message, "status": status, "extra_info": videosSearch.result()}, status_code=200)
